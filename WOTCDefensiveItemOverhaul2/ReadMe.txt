...
Plated Armor now grants +1 HP. Powered Armor grants +2 HP. You can now gradually upgrade all Armor with an increasing Ablative HP bonus by purchasing upgrades in Engineering after your perform the required research or autopsy. 

There are six upgrades in total, unlocked by:[list]
[*] Hybrid Materials
[*] ADVENT Trooper Autopsy
[*] ADVENT Shieldbearer Autopsy
[*] Chryssalid Autopsy
[*] Andromedon Autopsy
[*] Sectopod Autopsy[/list]
...
Out of the box, the mod is compatible with all Vanilla and DLC Armors, as well as mod-added Armors that use the vanilla passive abilities for their stat bonuses. 
...
[url=https://steamcommunity.com/sharedfiles/filedetails/?id=2222330444][b]Heavy And Light Kevlar Armors[/b][/url] - supported.
